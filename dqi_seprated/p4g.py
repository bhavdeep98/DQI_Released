...
gwords=pd.read_csv("/home/srmishr1/MNLI/Anjana/dev_good_words.csv")
#print(gwords)
...
def parameter4(sentence,size,WSIML):
    ...
    df.to_csv("/home/srmishr1/MNLI/Anjana/wordsimgabs.csv")
    df=pd.DataFrame(vals)
    df.to_csv("/home/srmishr1/MNLI/Anjana/dqic4gabs.csv")  

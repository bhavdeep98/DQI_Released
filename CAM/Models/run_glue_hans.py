...
class SnliProcessor(DataProcessor):                                             
    ...
    def get_train_examples(self, data_dir):                                     
        ...
        return self._create_examples(                                           
            ...
            #self._read_tsv(os.path.join(data_dir, "train_adv_41753_hans.tsv")), "train")      
            self._read_tsv(os.path.join(data_dir, "train_Full_Adv_Roberta_hans.tsv")), "train")      
            #self._read_tsv(os.path.join(data_dir, "train_hans.tsv")), "train")
                                                                                
    def get_dev_examples(self, data_dir):                                       
        """See base class."""                                                   
        return self._create_examples(                                           
            #self._read_tsv(os.path.join(data_dir, "snli_1.0_test.txt")),"dev_matched")
            self._read_tsv(os.path.join(data_dir, "test_hans.tsv")),"dev_matched")
...
def main():
    ...
    parser.add_argument(
        "--per_gpu_train_batch_size", default=64, type=int, help="Batch size per GPU/CPU for training.",
    )
    parser.add_argument(
